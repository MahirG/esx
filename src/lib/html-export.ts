...
const STYLES = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header {
    background: linear-gradient(135deg, oklch(0.52 0.14 162), oklch(0.40 0.10 162));
    color: white;
    padding: 32px 40px;
    display: flex;
  ...
  th {
    background: oklch(0.52 0.14 162);
    color: white;
    padding: 12px 16px;
    text-align: left;
    font-size: 12px;
  ...
  .totals .row.grand {
    font-size: 18px;
    font-weight: 700;
    color: oklch(0.40 0.10 162);
    border-bottom: 2px solid oklch(0.52 0.14 162);
    padding: 12px 0;
  }
  .footer {
    margin-top: 40px;
  ...
  .badge.success { background: oklch(0.52 0.14 162 / 0.15); color: oklch(0.40 0.10 162); }
  .badge.warning { background: oklch(0.72 0.13 75 / 0.2); color: oklch(0.50 0.10 75); }
  .badge.danger { background: oklch(0.58 0.22 27 / 0.15); color: oklch(0.45 0.20 27); }
  .status-bar {
    display: flex;
    align-items: center;
    gap: 16px;
  ...
  .status-bar.success { background: oklch(0.52 0.14 162 / 0.08); border: 1px solid oklch(0.52 0.14 162 / 0.2); }
  .status-bar.warning { background: oklch(0.72 0.13 75 / 0.1); border: 1px solid oklch(0.72 0.13 75 / 0.3); }
  .tax-breakdown {
    background: #f8f6f0;
    border-radius: 8px;
    padding: 24px;
